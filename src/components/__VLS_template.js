import { __VLS_internalComponent, __VLS_componentsOption, __VLS_name } from './Navigation.vue';
...
({} as __VLS_IntrinsicElements).h1; ({} as __VLS_IntrinsicElements).h1; ({} as __VLS_IntrinsicElements).h1;
{
